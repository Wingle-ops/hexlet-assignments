...
class AppTest {
    ...
    void testReversedSequence1() {
        CharSequence str = new ReversedSequence("Hello, World!");
        assertThat(str.toString()).isEqualTo("!dlroW ,olleH");
        assertThat(str.charAt(3)).isEqualTo('r');
        assertThat(str.length()).isEqualTo(13);
        assertThat(str.subSequence(1, 4).toString()).isEqualTo("dlr");
    }
}
